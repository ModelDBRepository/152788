...
function runSimFig2D()
  ...
  disp('python runSimWorker.py input/Fig2D-X-Y-range-summary.txt 1')
  disp('python runSimWorker.py input/Fig2D-X-Y-range-summary.txt 2')
  disp('python runSimWorker.py input/Fig2D-X-Y-range-summary.txt 3')
